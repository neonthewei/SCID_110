...
export default function WorkDetailClient({ params }: { params: { id: string } }) {
      ...
      <div className="relative z-10">
        ...
        <div className="pt-[100px] pb-32">
          <div className="container">
            <h2 className="text-[24px] font-medium mb-8" style={{ color: themeColor }}>設計概念</h2>
            
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              {/* Design Concept Text */}
              <div className="prose max-w-none order-2 lg:order-1">
                {work.longDescription.split('\n\n').map((paragraph, index) => (
                  <p key={index} className="text-[15px] text-[#9D9D9D] leading-[1.8] mb-6 last:mb-0">
                    {paragraph.split('\n').map((line, lineIndex) => (
