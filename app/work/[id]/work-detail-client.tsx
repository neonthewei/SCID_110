      ...
      <div className="relative z-10">
        ...
        <div className="container pb-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-12">
            ...
            <div className="flex flex-col justify-center h-full">
              <div>
                <h1
                  className="text-[28px] md:text-[32px] font-medium mb-2 leading-tight"
                  style={{ color: themeColor }}
                >
                  {work.title.main}
                </h1>
                <h2
                  className="text-[14px] md:text-[15px] mb-2 md:mb-6"
                  style={{ color: themeColor }}
                >
                  {work.title.sub}
                </h2>
                ...
                <div className="flex flex-wrap items-center gap-4 mb-2 md:mb-0">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[15px] text-[#9D9D9D]">
        ...
        <div className="pt-[100px] pb-32">
          <div className="container">
            <h2
              className="text-[24px] font-medium mb-8"
              style={{ color: themeColor }}
            >
              設計概念
            </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="prose max-w-none order-2 lg:order-1">
                {work.longDescription.split("\n\n").map((paragraph, index) => (
                  <p
                    key={index}
                    className="text-[15px] text-[#9D9D9D] leading-[1.8] mb-6 last:mb-0"
                  >
                    {paragraph.split("\n").map((line, lineIndex) => (
