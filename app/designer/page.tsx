...
export default function DesignerPage() {
  ...
  return (
    <div className="min-h-screen relative bg-white">
      <div className="mx-auto max-w-[1160px] relative z-[30] min-h-screen">
        <div className="px-8 sm:px-8 md:px-16 lg:px-24 pt-8 pb-20 text-center">
            ...
            <div className="flex gap-2">
              ...
              <div className="relative">
                <button
                  ...
                  className={`inline-flex items-center justify-center h-[42px] px-3.5 rounded-2xl border border-gray-300 bg-white shadow-sm hover:bg-gray-50 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 ${
                    showFilter ? "bg-gray-50" : ""
                  }`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2 sm:gap-4">
            {filteredDesigners.map((designer) => (
              ...
              >
                <div className="bg-white transform transition-all duration-300 w-full mx-auto rounded-lg overflow-hidden relative aspect-[3/4] min-h-[200px]">
                  <Image
                    src={
                      designer.image || "/placeholder.svg?height=600&width=400"
                    }
                  ...
                  <div
                    className={`absolute inset-0 transition-all duration-500 bg-gradient-to-r
                      ${
                        designer.works[0] &&
                        designer.works[0].category === "舒適巢"
                          ? "from-[#8CBB28]/50"
                          : designer.works[0] &&
                            designer.works[0].category === "溫工藝"
                          ? "from-[#DA6615]/50"
                          : designer.works[0] &&
                            designer.works[0].category === "熱對話"
                          ? "from-[#C3206D]/50"
                          : "from-[#3DB5E9]/50"
                      }
                      ${
                        designer.works[1]
                          ? designer.works[1].category === "舒適巢"
                            ? "to-[#8CBB28]/50"
                            : designer.works[1].category === "溫工藝"
                            ? "to-[#DA6615]/50"
                            : designer.works[1].category === "熱對話"
                            ? "to-[#C3206D]/50"
                            : "to-[#3DB5E9]/50"
                          : designer.works[0].category === "舒適巢"
                          ? "to-[#8CBB28]/50"
                      ...
                      <div
                        className={`absolute inset-0 ${
                          activeDesignerId === designer.id
                            ...
                            : "sm:group-hover:opacity-0 opacity-100"
        ...
        <div className="mt-24">
          ...
          <div className="mb-32">
            <div className="relative mb-8 px-8 sm:px-12 md:px-16 lg:px-24">
              <h2 className="text-[#7D7D7D] text-base pb-4 text-left">
                畢業班指導老師
                <span className="text-[#9D9D9D] text-xs block sm:inline sm:ml-1">
                  (按姓氏筆畫為序，首位為主導老師)
                </span>
              </h2>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-wrap gap-6 px-12 sm:px-8 md:px-16 lg:px-24 lg:min-w-[1200px]">
                {[
                  {
                    name: { zh: "何信坤", en: "Quen Ho" },
                    img: "/teacher/teacher1.jpg",
                  },
                  {
                    name: { zh: "丑宛茹", en: "Wan-Ru Chou" },
                    img: "/teacher/teacher2.jpg",
                  },
                  {
                    name: { zh: "朱旭正", en: "Hsu-Cheng Chu" },
                    img: "/teacher/teacher3.jpg",
                  },
                  {
                    name: { zh: "林曉瑛", en: "Sally Lin" },
                    img: "/teacher/teacher4.jpg",
                  },
                  {
                    name: { zh: "孫崇實", en: "Chung-Shih Sun" },
              ...
              <div className="flex flex-wrap gap-6 px-12 sm:px-8 md:px-16 lg:px-24">
                {[
                  {
                    name: { zh: "徐景亭", en: "Gina Hsu" },
                    img: "/teacher/teacher5.jpg",
                  },
                  {
                    name: { zh: "陳禧冠", en: "Shi-Kuan Chen" },
                    img: "/teacher/teacher6.jpg",
                  },
                  {
                    name: { zh: "宮保睿", en: "Paul Gong" },
                    img: "/teacher/teacher7.jpg",
                  },
                  {
                    name: { zh: "曾熙凱", en: "Shi-Kai Tseng" },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-y-8 lg:gap-y-16 lg:gap-x-80">
              ...
              <div className="space-y-6 lg:-ml-0 w-[300px]">
                ...
                <div className="pb-6 border-b border-dashed border-[#9D9D9D]/50">
                  <div className="flex">
                    <h3 className="text-[#7D7D7D] w-28 flex-shrink-0 text-left text-sm break-keep whitespace-pre-line leading-5">
                      總幹事
                    </h3>
              ...
              <div className="space-y-6 w-[300px] lg:translate-x-[-11rem]">
                ...
                <div className="pb-6 border-b border-dashed border-[#9D9D9D]/50">
                  <div className="flex">
                    <h3 className="text-[#7D7D7D] w-28 flex-shrink-0 text-left text-sm">
                      總務
                    </h3>
                    <ul className="space-y-2 min-w-[200px]">
                      <li className="flex items-baseline gap-2">
      ...
      <div className="absolute top-0 left-0 w-full h-screen overflow-hidden pointer-events-none z-[20]">
        {/* 桌面版的背景圖片顯示邏輯 */}
        {filteredDesigners.map((designer) => (
          <div key={designer.id} className="hidden sm:block">
            {/* Left background image */}
            <img
              src={`/reserve/${
                designer.works[0]?.category === "冷火花"
                  ? "reserve_bg_1.png"
                  : designer.works[0]?.category === "熱對話"
                  ? "reserve_bg_2.png"
                  : designer.works[0]?.category === "舒適巢"
        ...
        {activeDesignerId &&
          filteredDesigners.map(
            (designer) =>
              designer.id === activeDesignerId && (
                <div key={`mobile-${designer.id}`} className="block sm:hidden">
                  {/* Left background image */}
                  <img
                    src={`/reserve/${
                      designer.works[0]?.category === "冷火花"
                    ...
                    alt=""
                    className="bg-image-container bg-image-left transition-opacity duration-500 animate-slow-spin-reverse opacity-100"
                  />
                  {/* Right background image */}
                  <img
                    src={`/reserve/${
                    ...
                    alt=""
                    className="bg-image-container bg-image-right transition-opacity duration-500 animate-slow-spin opacity-100"
                  />
                </div>
              )
          )}
        ...
        {/* Default background images for mobile when no designer is selected */}
        {!activeDesignerId && (
