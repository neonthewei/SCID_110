...
export default function DesignerPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="mx-auto px-4 sm:px-8 md:px-12 lg:px-0 pt-8 pb-20 text-center max-w-[1200px] relative z-10">
        <motion.div
          key="header"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          ...
          <div className="flex gap-2">
            ...
            <div className="relative">
              ...
              {showFilter && (
                <div
                  id="filter-menu"
                  className="absolute right-0 mt-2 w-48 rounded-2xl bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-10"
                >
                  <div className="py-1">
                    <button
                      onClick={() => {
                      ...
                      className={`block w-full px-4 py-2 text-left text-sm hover:bg-gray-50 ${
                        sortOrder === null ? 'text-black font-medium' : 'text-gray-700'
                      }`}
                    >
                      無
                    </button>
                    <button
                      ...
                      className={`block w-full px-4 py-2 text-left text-sm hover:bg-gray-50 ${
                        sortOrder === 'high-to-low' ? 'text-black font-medium' : 'text-gray-700'
                      }`}
                    >
                      ˚S由高到低
                    </button>
                    <button
                      ...
                      className={`block w-full px-4 py-2 text-left text-sm hover:bg-gray-50 ${
                        sortOrder === 'low-to-high' ? 'text-black font-medium' : 'text-gray-700'
                      }`}
                    >
                      ˚S由低到高
                    </button>
              ...
              <div className="bg-white transform transition-all duration-300 w-full mx-auto rounded-2xl overflow-hidden relative aspect-[3/4]">
                ...
                <div className="absolute bottom-4 left-4 right-4 transform">
                  <div className="h-[48px] relative">
                    ...
                    } flex flex-col justify-center items-center text-white bg-black/15 backdrop-blur-md backdrop-saturate-150 rounded-xl border border-white/30 transition-all duration-500 ease-in-out h-[48px]`}>
        ...
        <div className="mt-32">
          ...
          <div className="mb-32">
            <div className="relative mb-8">
              <h2 className="text-[#7D7D7D] text-base pb-4 text-left">畢業班指導老師<span className="text-[#9D9D9D] text-xs ml-1">（按姓氏筆畫為序，首位為主導老師）</span></h2>
              <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-[#B3346F] via-[#A5297F] to-[#FFFFFF]"></div>
            </div>
            <div className="flex flex-col gap-8">
              {/* First Row */}
              <div className="flex flex-wrap gap-x-16 gap-y-8 px-4">
                {[
                  ...
                  <div key={index} className="flex items-center gap-4 w-[180px]">
          ...
          <div className="mt-8 flex justify-center px-4 sm:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-y-16 lg:gap-x-80">
              ...
              {/* Column 2: 2 teams */}
              <div className="space-y-6 lg:-ml-24 w-[330px]">
                {/* 展場布置與設計 */}
                <div className="pb-6 border-b border-dashed border-[#9D9D9D]/50">
                  <div className="flex">
              ...
              {/* Column 3: 4 teams */}
              <div className="space-y-6 lg:-ml-36 w-[330px]">
                {/* 公關活動企劃與執行 */}
                <div className="pb-6 border-b border-dashed border-[#9D9D9D]/50">
                  <div className="flex">
