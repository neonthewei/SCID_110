...
export default function ShihChienExhibition() {
  return (
    <div className="min-h-screen pb-24 relative bg-gray-50">
        ...
        <div className="relative z-20 h-full">
          ...
          >
            <div className="max-w-[1280px] mx-auto">
              ...
              <p className="text-[14px] sm:text-[18px] opacity-90 sm:opacity-100 text-center sm:text-left">2025 實踐大學工業產品設計學系畢業展</p>
            </div>
          </motion.div>
        </div>
      </div>
                ...
                <div className="space-y-4 sm:space-y-0">
                  <div className="sm:pb-2">
                    <div className="flex items-center">
                      ...
                      <p className="text-[#9D9D9D] text-[13px] sm:text-sm">2025.04.24 - 2025.05.07</p>
                    </div>
                  </div>
                  <div className="sm:pb-2">
                    <div className="flex items-center">
                  ...
                  <div>
                    <div className="flex items-start">
                      ...
                      <div className="text-[#9D9D9D] text-[13px] sm:text-sm">
                        <span className="block sm:inline">實踐大學 台北校區M棟B1</span>
                        <span className="block text-[#9D9D9D]/80 mt-0.5 sm:mt-0 sm:inline sm:before:content-['_']">（崇實路入口）</span>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div className="px-4 md:px-8 lg:px-16 py-6 sm:py-16">
        <div className="max-w-[1280px] mx-auto">
          <h2 className="text-lg sm:text-2xl font-bold text-[#7D7D7D] mb-6 sm:mb-8">3D 虛擬展場</h2>
