    ...
    >
      ...
      <div className="max-w-4xl mx-auto relative z-[20] w-full px-4 sm:px-6 lg:px-8 py-4">
        <div className="text-center mb-10 mt-5">
          <h1 className="text-[22px] sm:text-title mb-4 font-bold">
            填寫預約表單
          </h1>
        ...
        <div className="bg-white shadow rounded-2xl p-6 mb-4">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="flex items-center justify-center mb-8">
              ...
              <div
                className={`w-12 sm:w-16 h-0.5 mx-2 sm:mx-4 self-center transition-colors duration-300 ${
        ...
        {showBookings && (
          <div className="bg-white shadow rounded-2xl p-6">
            <h2 className="text-[22px] sm:text-title mb-4">最近預約記錄</h2>
